...
- Please register as directed on the [Registration form](reg_form_2009.doc) , and send the form with payment to Dr Sue Niebrzydowski, School of English, Bangor University, Gwynedd, LL57 2DG by by **3 March 2009** .  

- Should you need overnight accommodation on Friday 28 or Saturday 29 March, please refer to the [Accommodation section](#accommodation) below.
...
- Research: the following will give papers at the meeting: Meg Twycross (Lancaster), Phil Butterworth (Leeds), Claire Wright (Nottingham), Penny Granger (Cambridge), Michele Pasin (Southampton), and Jessica Freeman (Southampton).  

- The day will either include a performance in the Chapel of an adaptation of *Piers Plowman* Passus XVIII (Harrowing of Hell) by third year Drama/English students (tbc), or tour of the picture gallery.  
...
<a xmlns="http://www.w3.org/1999/xhtml"
   name="registration"
   id="registration">Copies</a>of the [Registration Form](Reg_form_2009.doc) are available here. Please print it off: do not attempt to fill it in on-line!
